...
A **Threaded Binary Tree** replaces these `NULL` pointers with "threads" that point to the node's Inorder Predecessor or Successor. This makes Inorder traversal much faster without using a Stack or Recursion!
